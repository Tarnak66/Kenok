...
if not st.session_state.logged_in:
    ...
    with col2:
        ...
        st.write("---")
        st.info("За да използвате Kenok, първо трябва да си направите профил. Това става лесно и бързо: измислете име и парола. За да влезете отново след това, просто трябва да въведете същите данни.")
